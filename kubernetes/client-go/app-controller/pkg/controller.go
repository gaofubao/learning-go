...
import (
	...
	appcontrollerv1 "app-controller/pkg/apis/appcontroller/v1"
	...
	informers "app-controller/pkg/generated/informers/externalversions/appcontroller/v1"
	listers "app-controller/pkg/generated/listers/appcontroller/v1"
)
...
func newDeployment(app *appcontrollerv1.App) *appsv1.Deployment {
...
func newService(app *appcontrollerv1.App) *corev1.Service {
	labels := map[string]string{
		"app":        "app-service",
		"controller": app.Name,
	}
...
func newIngress(app *appcontrollerv1.App) *netv1.Ingress {
